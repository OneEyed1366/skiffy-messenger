...
| ------- | --------------------------- |
| T7.05   | usePostsStore               |
| T10b.\* | All post-related components |

## Description

Migrate post-related constants from Mattermost webapp including PostTypes, system post types, post request types, post list identifiers, and post-related socket events.
 ...
 * Migrated from: vendor/.../constants/posts.ts
 */
...
- [ ] No magic strings - all values are typed
