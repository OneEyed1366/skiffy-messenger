...
| T8.03   | useCurrentChannel             |
| T8.05   | useChannel                    |
| T10a.\* | Sidebar components            |
| T10d.\* | Channel management components |

## Description

Migrate channel-related TypeScript types from Mattermost.

## Source File

`vendor/desktop/webapp/platform/types/src/channels.ts`
...
export type IChannelType = "O" | "P" | "D" | "G";
...
- [ ] All channel types migrated
- [ ] All types prefixed with `I`
- [ ] Proper organization with `#region`
- [ ] Exported from index
- [ ] TypeScript compiles
